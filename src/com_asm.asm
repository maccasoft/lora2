...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
; Modified by Fabio Coatti to avoid port access when the port itself is not
; initialized. Not well tested.
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;                       ;;  
;;     DEFINITIONS       ;;
...
;       
	cmp     Port,255                ;controlla se la Port e' inizializzata
	je      noinit2                 ;no, esci dalla routine.
					;si, continua
;
...
;       
	cmp     Port,255                ;controlla se la Port e' inizializzata
	je      noinit3                 ;no, esci dalla routine.
					;si, continua
;
...
;       
	cmp     Port,255                ;controlla se la Port e' inizializzata
	je      noinit4                 ;no, esci dalla routine.
					;si, continua
;
...
;       
	cmp     Port,255                ;controlla se la Port e' inizializzata
	je      nothing_here            ;no, esci dalla routine.
					;si, continua
;
...
;       
	cmp     Port,255                ;controlla se la Port e' inizializzata
	je      noinit5                 ;no, esci dalla routine.
					;si, continua
;
...
;       
	cmp     Port,255                ;controlla se la Port e' inizializzata
	je      noinit6                 ;no, esci dalla routine.
					;si, continua
;
...
;       
	cmp     Port,255                ;controlla se la Port e' inizializzata
	je      noinit7                 ;no, esci dalla routine.
					;si, continua
;
...
;       
	cmp     Port,255                ;controlla se la Port e' inizializzata
	je      noinit8                 ;no, esci dalla routine.
					;si, continua
;
...
;       
	cmp     Port,255                ;controlla se la Port e' inizializzata
	je      noinit9                 ;no, esci dalla routine.
					;si, continua
;
...
;       
	cmp     Port,255                ;controlla se la Port e' inizializzata
	je      noinitA                 ;no, esci dalla routine.
					;si, continua
;
