...
void bbs_newusers ()
{
   ...
   do {
      ...
      wmenuitem (14, 32," Random bithdate check  ", 0, 19, 0, NULL, 0, 0);
...
void bbs_general ()
{
   ...
   wh = wopen (1, 4, 21, 76, 1, LCYAN|_BLACK, CYAN|_BLACK);
   wactiv (wh);
   wshadow (DGREY|_BLACK);
   ...
   do {
      ...
      wmenuitem (7, 1," ANSI at logon      ", 0, 5, 0, NULL, 0, 0);
      wmenuitem (8, 1," Puma/MPT protocol  ", 0, 6, 0, NULL, 0, 0);
      wmenuitem (9, 1," HS/Link protocol   ", 0, 7, 0, NULL, 0, 0);
      wmenuitem (10, 1," Snoop on-line user ", 0, 8, 0, NULL, 0, 0);
      wmenuitem (7, 30," Aftercaller exit   ", 0, 9, 0, NULL, 0, 0);
      wmenuitem (8, 30," Areachange keys    ", 0, 10, 0, NULL, 0, 0);
      ...
      if (config.ansilogon == 0)
         wprints (7, 22, CYAN|_BLACK, "No");
      else if (config.ansilogon == 1)
         wprints (7, 22, CYAN|_BLACK, "Auto");
      else if (config.ansilogon == 2)
         wprints (7, 22, CYAN|_BLACK, "Ask");
      else if (config.ansilogon == 3)
         wprints (7, 22, CYAN|_BLACK, "Yes");
      wprints (8, 22, CYAN|_BLACK, config.puma ? "Yes" : "No");
      wprints (9, 22, CYAN|_BLACK, config.hslink ? "Yes" : "No");
      wprints (10, 22, CYAN|_BLACK, config.snooping ? "Yes" : "No");
      sprintf (string, "%d", config.aftercaller_exit);
      wprints (7, 51, CYAN|_BLACK, string);
      wprints (8, 51, CYAN|_BLACK, config.areachange_key);
      ...
      switch (i) {
         ...
         case 9:
            sprintf (string, "%d", config.aftercaller_exit);
            winpbeg (BLUE|_GREEN, BLUE|_GREEN);
            winpdef (7, 51, string, "???", 0, 1, NULL, 0);
            if (winpread () != W_ESCPRESS)
...
void bbs_message ()
{
   ...
   do {
      ...
      if (sys.netmail)
         ...
         wprints (3, 16, CYAN|_BLACK, "Passthrough");
   ...
   do {
      ...
      switch (i) {
	    ...
	    break;
         ...
         case 4:
            wh1 = wopen (8, 28, 15, 53, 1, LCYAN|_BLACK, CYAN|_BLACK);
            wactiv (wh1);
            wshadow (DGREY|_BLACK);
...
//               wmenuitem (4, 1, "Tiny SEEN-BY    ", 0, 5, 0, NULL, 0, 0);
         ...
         case 6:
            if (nsys.quick_board) {
               nsys.pip_board = nsys.quick_board;
               nsys.quick_board = 0;
	    }
            else if (nsys.pip_board) {
               nsys.pip_board = 0;
               ...
               if (atoi (nsys.msg_path))
                  nsys.quick_board = atoi (nsys.msg_path);
	       else
