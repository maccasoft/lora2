...
char *argv[];
{
   ...
   printf("\nLTOP; LoraBBS Top User utility, Version 2.10\n");
   ...
   if ( (!ul_times && !dl_times && !ul_kbytes && !dl_kbytes &&
         !calls && !msg_posted) || argc == 1 || !name[0] )
   {
      printf("Usage   : LTOP Output_FileName List_Type\n\n");
                                                                                
      printf("List type is : -Un = Upload Times\n");
      printf("               -Dn = Download Times\n");
      printf("               -Sn = Download KiloBytes\n");
      printf("               -Rn = Upload KiloBytes\n");
      printf("               -Cn = Calls\n");
...
char *name;
{
   ...
   fprintf (fp, "\n\n     ");
   fprintf (fp, "NGenerated by LoraTop 2.00  Copyright (c) 1991-92 by Marco Maccaferri\n\n");
