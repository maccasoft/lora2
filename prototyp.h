...
void quick_scan_message_base (int, int, char);
...
void quick_save_message2 (FILE *, FILE *, FILE *, FILE *, FILE *, FILE *);
void pip_save_message2 (FILE *, FILE *, FILE *, FILE *);
void squish_save_message2 (FILE *);
void display_percentage (int, int);
float IEEToMSBIN (float f);
int quick_scan_messages (int *, int *, int, int, int, int, int, FILE *, char);
...
int quick_export_mail (int, struct _fwrd *);
